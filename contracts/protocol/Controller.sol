...
contract Controller is Initializable, AccessControlUpgradeable{
    ...
    modifier futurePlatformDeployerIsValid(address _futurePlatformDeployerAddress){
        require(registry.isRegisteredFuturePlatformDeployer(_futurePlatformDeployerAddress),"incorrect futurePlatform address");
        _;
    }
    ...
    */
    ...
    function getFutureIBTSymbol(string memory _ibtSymbol, string memory _platfrom, uint256 _periodDuration) public pure returns(string memory){
